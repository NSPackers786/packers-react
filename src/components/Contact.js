  ...
  return (
    <section id="contact" className="contact py-16 bg-gradient-to-r from-blue-900 to-blue-600 text-white">
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Have questions about moving services? Contact NS Packers and Movers for a seamless, stress-free moving experience."
        />
        <meta
          name="keywords"
          content="contact NS Packers and Movers, relocation services, moving questions, professional movers contact"
        />
        <meta property="og:title" content="Contact NS Packers and Movers" />
        <meta
      ...
      <div className="container mx-auto text-center px-6">
        ...
        >
          <h2 className="text-4xl font-semibold mb-6" id="contact-form-header">
            Get in Touch with NS Packers and Movers
          </h2>
          <p className="text-lg mb-8">
            Have questions? We’re here to help! Reach out to us, and we'll get back to you as soon as possible.
          </p>
